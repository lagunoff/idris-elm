...
-- Ported from https://github.com/elm-lang/html/blob/2.0.0/src/Html/Attributes.elm
%default total
%access public export


data Attribute : Type -> Type where
  MkAttribute : (ref : JSRef) -> Attribute a
  
%used MkAttribute ref


unpack : Attribute msg -> Ptr
unpack (MkAttribute ptr) = ptr
...
style : Styles -> Attribute msg
style xs =
  MkAttribute $ unsafePerformIO $ jscall "_elm_lang$virtual_dom$Native_VirtualDom.style(%0)" (Ptr -> JS_IO Ptr) (unpack xs)
...
property : String -> JSValue c -> Attribute msg
property k v =
  MkAttribute $ unsafePerformIO $ jscall "A2(_elm_lang$virtual_dom$Native_VirtualDom.property, %0, %1)" (String -> Ptr -> JS_IO Ptr) k (unpack v)


stringProperty : String -> String -> Attribute msg
stringProperty name string =
  property name $ toJS {to=JSString} string


boolProperty : String -> Bool -> Attribute msg
boolProperty name bool =
  property name $ toJS {to=JSBoolean} bool
...
accesskey char =
  stringProperty "accessKey" (show char)
